...
import { useAnalytics, type AggregateRow, type RangeKey } from '@/hooks/useAnalytics';
  ...
  return (
    <Card className="p-4 sm:p-6 lg:p-8">
      <CardHeader>
        ...
        <CardDescription>A year view highlighting which days you spend the most.</CardDescription>
      </CardHeader>
