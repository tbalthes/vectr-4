...
export function TransactionSearch({
  ...
  const filteredTransactions = useMemo(() => {
    console.log("TransactionSearch filtering - received transactions:", transactions.length, "searchTerm:", searchTerm);
  ...
  React.useEffect(() => {
    console.log("TransactionSearch useEffect - emitting", filteredTransactions.length, "filtered transactions");
