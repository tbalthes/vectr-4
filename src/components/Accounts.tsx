...
const recentAccountActivity = [
  { id: 1, account: 'Primary Checking', description: 'Direct Deposit', amount: 3500.00, date: '2024-01-15' },
  { id: 2, account: 'Freedom Unlimited', description: 'Online Purchase', amount: -89.99, date: '2024-01-14' },
  { id: 3, account: 'High Yield Savings', description: 'Interest Payment', amount: 52.30, date: '2024-01-10' },
  { id: 4, account: 'Investment Portfolio', description: 'Dividend Payment', amount: 125.50, date: '2024-01-12' },
];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex space-x-2">
          <Button variant="outline" onClick={() => setBalancesVisible(!balancesVisible)}>
            {balancesVisible ? <EyeOff className="mr-2 h-4 w-4" /> : <Eye className="mr-2 h-4 w-4" />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">Across {accountsData.filter(acc => acc.type !== 'credit').length} accounts</p>
          </CardContent>
        </Card>
                ...
                {account.type === 'credit' && account.creditLimit && (
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ${account.creditLimit - Math.abs(account.balance)} available
                    </p>
                  </div>
                )}
              ...
              <div key={activity.id} className="flex items-center justify-between py-3 border-b last:border-b-0">
                <div className="flex items-center space-x-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    activity.amount > 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                  }`}>
                    {activity.amount > 0 ? (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{activity.account} • {activity.date}</p>
                  </div>
                </div>
