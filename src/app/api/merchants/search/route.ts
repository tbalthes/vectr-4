...
export async function GET(request: NextRequest) {
  const requestId = `merchant_search_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`;
...
function rankSearchResults(merchants: TransformedMerchant[], query: string): TransformedMerchant[] {
