...
def get_status(data_cache = Depends(get_data_cache)):
    return {
        ...
        "last_refresh_phoenix": data_cache.last_refresh_phoenix.isoformat() if hasattr(data_cache, 'last_refresh_phoenix') and data_cache.last_refresh_phoenix else None,
